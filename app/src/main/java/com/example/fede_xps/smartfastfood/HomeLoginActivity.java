...
public class HomeLoginActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bx = (Button) findViewById(R.id.startQR);
        bx.setText("GO to QR scan");
    ...
    public void startQRC() {
        Intent start = new Intent(HomeLoginActivity.this, QRCodeActivity.class);
